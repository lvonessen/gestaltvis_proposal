...
\usepackage[tmargin=.9in,bmargin=.9in,lmargin=.9in,rmargin=.9in]{geometry}
\usepackage{setspace}
\usepackage{comment}
\usepackage{enumitem}
\usepackage{graphicx}
